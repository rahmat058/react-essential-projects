...
const variantClasses: Record<ButtonVariant, string> = {
  primary:
    'bg-gradient-to-r from-violet-500 via-fuchsia-500 to-indigo-500 text-white shadow-lg shadow-violet-500/25 hover:from-violet-600 hover:via-fuchsia-600 hover:to-indigo-600',
  secondary:
  ...
  outline: 'border border-violet-200 bg-white/70 text-violet-700 hover:border-violet-300 hover:bg-white',
}
